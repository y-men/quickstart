package qs.recipe.bootstrap;

import guru.springframework.domain.*;
import qs.recipe.domain.*;
import qs.recipe.repositories.CategoryRepository;
import qs.recipe.repositories.RecipeRepository;
import qs.recipe.repositories.UnitOfMeasureRepository;
